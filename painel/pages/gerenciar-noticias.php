...
<div class="box-content">
    <h2><i class="fa fa-address-card"></i> Notícias Cadastradas</h2>
<div class="wraper-table">
    ...
    ?>
        ...
        <td><a class="btn edit" href="<?php INCLUDE_PATH_PAINEL ?>editar-noticia?id=<?php echo $value['id']; ?>"><i class="fa fa-pen"></i>Editar</a></td>
        <td><a actionBtn='delete' class="btn delete" href="<?php INCLUDE_PATH_PAINEL ?>gerenciar-noticias?excluir=<?php echo $value['id'] ?>"><i class="fa fa-trash"></i>Excluir</a></td>
